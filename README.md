...
Edita el systemPrompt en worker.js para cambiar el tono o añadir leyes.
Cambia el modelo de Groq: llama-3.1-8b-instant o mixtral-8x7b-32768.

---

## 💜 LiberaEc: porque ninguna mujer debe caminar sola. 💜

## 💜 Hecho con DeepSeek (Vibe Coding), GitHub, Cloudflare y Groq 💜
